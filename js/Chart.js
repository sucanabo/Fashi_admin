                                        ...
                                        M =
                                            "flex" === k.barThickness
                                                ...
                                                : ((n = e),
                                                  ...
                                                  (d = a.stackCount),
                                                  (c = a.pixels[n]),
                                                  o.isNullOrUndef(u) ? ((s = a.min * r.categoryPercentage), (l = r.barPercentage)) : ((s = u * d), (l = 1)),
                            ...
                            t.controllers.polarArea = t.DatasetController.extend({
                                ...
                                updateElement: function (t, e, i) {
                                    ...
                                    o.extend(t, {
                                        ...
                                        _index: e,
                                        _scale: u,
                                        _model: { x: h, y: f, innerRadius: 0, outerRadius: i ? k : b, startAngle: i && l.animateRotate ? v : x, endAngle: i && l.animateRotate ? v : y, label: o.valueAtIndexOrDefault(d, e, d[e]) },
                                    }),
                                    ...
                                    (n = c[e]),
                                        ...
                                        n.model.skip ||
                                            ...
                                            (o.almostEquals(n.deltaK, 0, this.EPSILON)
                                                ? (n.mK = a.mK = 0)
                                                : ((r = n.mK / n.deltaK), (s = a.mK / n.deltaK), (u = Math.pow(r, 2) + Math.pow(s, 2)) <= 9 || ((l = 3 / Math.sqrt(u)), (n.mK = r * l * n.deltaK), (a.mK = s * l * n.deltaK))));
                                for (e = 0; e < h; ++e)
                                    (n = c[e]).model.skip ||
                                        ((i = e > 0 ? c[e - 1] : null),
                                        (a = e < h - 1 ? c[e + 1] : null),
                ...
                function (t, e, i) {
                    ...
                    e.exports = {
                        ...
                        update: function (t, e, i) {
                            ...
                            function V(t) {
                                t.isHorizontal()
                                    ? ((t.left = t.fullWidth ? l : P), (t.right = t.fullWidth ? e - u : P + M), (t.top = W), (t.bottom = W + t.height), (W = t.bottom))
            ...
            32: [
                function (t, e, i) {
                    ...
                    n._set("scale", {
                        ...
                        ticks: { beginAtZero: !1, minRotation: 0, maxRotation: 50, mirror: !1, padding: 0, reverse: !1, display: !0, autoSkip: !0, autoSkipPadding: 0, labelOffset: 0, callback: r.formatters.values, minor: {}, major: {} },
                    }),
                        (e.exports = function (t) {
                            function e(t, e, i) {
                            ...
                            t.Scale = a.extend({
                                ...
                                fit: function () {
                                    ...
                                    if (
                                        ((n.width = f ? (t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth) : h && c.drawTicks ? p : 0), (n.height = f ? (h && c.drawTicks ? p : 0) : t.maxHeight), d.display && h)
                                    ) {
                                    ...
                                    if (u.display && h) {
                                        ...
                                        if (f) {
                                            ...
                                            0 !== t.labelRotation
                                                ? ((t.paddingLeft = "bottom" === l.position ? M * S + 3 : M * x + 3), (t.paddingRight = "bottom" === l.position ? M * x + 3 : M * C + 3))
                                ...
                                draw: function (t) {
                                    ...
                                    if (a.display) {
                                        ...
                                        if (
                                            (o.each(m, function (i, n) {
                                                if (!o.isNullOrUndef(i.label)) {
                                                    ...
                                                    n === e.zeroLineIndex && a.offset === h.offsetGridLines
                                                        ? ((r = h.zeroLineWidth), (s = h.zeroLineColor), (c = h.zeroLineBorderDash), (f = h.zeroLineBorderDashOffset))
                                            ...
                                            o.each(_, function (t) {
                                                if (
                                                    ...
                                                    var i = t.label;
                                                    if (o.isArray(i)) for (var n = i.length, a = 1.5 * b.size, r = e.isHorizontal() ? 0 : (-a * (n - 1)) / 2, l = 0; l < n; ++l) s.fillText("" + i[l], 0, r), (r += a);
                                            ...
                                            if (p) (F = e.left + (e.right - e.left) / 2), (O = "bottom" === a.position ? e.bottom - L - S.bottom : e.top + L + S.top);
                                                ...
                                                (F = z ? e.left + L + S.top : e.right - L - S.top), (O = e.top + (e.bottom - e.top) / 2), (R = z ? -0.5 * Math.PI : 0.5 * Math.PI);
                                            }
                                        ...
                                        if (h.drawBorder) {
                                            ...
                                            p ? ((N = V = "top" === a.position ? e.bottom : e.top), (N += E), (V += E)) : ((B = W = "left" === a.position ? e.right : e.left), (B += E), (W += E)),
                                                s.beginPath(),
                                                s.moveTo(B, N),
                                                s.lineTo(W, V),
                                                s.stroke();
                        ...
                        (e.exports = function (t) {
                            ...
                            (t.Tooltip = a.extend({
                                ...
                                update: function (e) {
                                    ...
                                    if (I.length) {
                                        ...
                                        C.filter &&
                                            ...
                                            (v = h + f),
                                            (b = g + f),
                                            "right" === p ? (d -= s.width) : "center" === p && ((d -= s.width / 2) + s.width > u.width && (d = u.width - s.width), d < 0 && (d = 0)),
                                ...
                                getCaretPosition: function (t, e, i) {
                                    ...
                                    else if (("left" === c ? ((n = (a = f + d + u) - u), (o = a + u)) : "right" === c ? ((n = (a = f + p - d - u) - u), (o = a + u)) : ((n = (a = i.caretX) - u), (o = a + u)), "top" === h))
                                        (s = (r = g) - u), (l = r);
                                    else {
                                        (s = (r = g + m) + u), (l = r);
                                        var v = o;
                                ...
                                handleEvent: function (t) {
                                    ...
                                    return (
                                        ...
                                        (e = !o.arrayEquals(i._active, i._lastActive)) && ((i._lastActive = i._active), (n.enabled || n.custom) && ((i._eventPosition = { x: t.x, y: t.y }), i.update(!0), i.pivot())),
                                        e
                                    );
                                },
                            })),
                            ...
                            draw: function () {
                                ...
                                for (
                                    ...
                                    (e = u[t]),
                                        ...
                                        (n = e._view),
                                        0 === t ? n.skip || (s.moveTo(n.x, n.y), (c = t)) : ((i = -1 === c ? i : u[c]), n.skip || ((c !== t - 1 && !l) || -1 === c ? s.moveTo(n.x, n.y) : o.canvas.lineTo(s, i._view, e._view), (c = t)));
                                s.stroke(), s.restore();
                            },
                        }));
                },
                    ...
                    n._set("global", { elements: { rectangle: { backgroundColor: n.global.defaultColor, borderColor: n.global.defaultColor, borderSkipped: "bottom", borderWidth: 0 } } }),
                        (e.exports = a.extend({
                            draw: function () {
                                ...
                                if (
                                    (l.horizontal
                                        ? ((t = l.base), (e = l.x), (i = l.y - l.height / 2), (n = l.y + l.height / 2), (a = e > t ? 1 : -1), (o = 1), (r = l.borderSkipped || "left"))
                                        : ((t = l.x - l.width / 2), (e = l.x + l.width / 2), (i = l.y), (a = 1), (o = (n = l.base) > i ? 1 : -1), (r = l.borderSkipped || "bottom")),
                                    u)
                                ) {
                ...
                function (t, e, i) {
                    ...
                    e.exports = {
                        ...
                        toPadding: function (t) {
                            var e, i, a, o;
                            return n.isObject(t) ? ((e = +t.top || 0), (i = +t.right || 0), (a = +t.bottom || 0), (o = +t.left || 0)) : (e = i = a = o = +t || 0), { top: e, right: i, bottom: a, left: o, height: e + a, width: o + i };
                        },
                                    ...
                                    (function (t, e, i, n, a, o) {
                                        ...
                                        for (t.beginPath(), r = 0, s = p + !!o; r < s; ++r)
                                            (h = i((u = e[(l = r % p)]._view), l, n)),
                                                (f = d(u)),
                                                (g = d(h)),
                                                f && g ? ((x = v.push(u)), (y = b.push(h))) : x && y && (m ? (f && v.push(u), g && b.push(h)) : (c(t, v, b, x, y), (x = y = 0), (v = []), (b = [])));
                            ...
                            if (a.display) {
                                ...
                                (e.fillStyle = i(a.fontColor, r.defaultFontColor)),
                                    ...
                                    t.isHorizontal()
                                        ...
                                        : ((l = "left" === a.position ? b + p : y - p), (u = v + (x - v) / 2), (s = x - v), (m = Math.PI * ("left" === a.position ? -0.5 : 0.5))),
                                    e.save(),
                                    e.translate(l, u),
                                    e.rotate(m),
                                    (e.textAlign = "center"),
                            ...
                            i = t.Scale.extend({
                                ...
                                buildTicks: function () {
                                    var t = this,
                                        ...
                                        o = (t.ticks = (function (t, e) {
                                            ...
                                            0 === s
                                                ? ((i = Math.floor(n.log10(e.minNotZero))), (a = Math.floor(e.minNotZero / Math.pow(10, i))), o.push(s), (s = a * Math.pow(10, i)))
                                ...
                                getPixelForValue: function (e) {
                                    ...
                                    return (
                                        ...
                                        e !== o && (0 === o && ((i -= h = n.getValueOrDefault(l.options.ticks.fontSize, t.defaults.global.defaultFontSize)), (o = c)), 0 !== e && (h += (i / (d(r) - d(o))) * (d(e) - d(o))), (a += s * h)),
                                        a
                                    );
                                },
            ...
            57: [
                function (t, e, i) {
                    ...
                    e.exports = function (t) {
                        ...
                        function u(t, e, i, n) {
                            if (a.isArray(e)) for (var o = i.y, r = 1.5 * n, s = 0; s < e.length; ++s) t.fillText(e[s], i.x, o), (o += r);
                                    ...
                                    ? (function (t) {
                                          ...
                                          for (e = 0; e < p; e++) {
                                              (n = t.getPointPosition(e, u)),
                                                  ...
                                                  (f = o.size),
                                                  (g = t.pointLabels[e] || ""),
                                                  (i = a.isArray(g) ? { w: a.longestText(h, h.font, g), h: g.length * f + 1.5 * (g.length - 1) * f } : { w: h.measureText(g).width, h: f }),
                                        ...
                                        if (s > 0 || o.reverse) {
                                            ...
                                            if (
                                                (n.display &&
                                                    ...
                                                    (function (t, e, i, n) {
                                                        var o = t.ctx;
                                                        if (((o.strokeStyle = a.valueAtIndexOrDefault(e.color, n - 1)), (o.lineWidth = a.valueAtIndexOrDefault(e.lineWidth, n - 1)), t.options.gridLines.circular))
                            ...
                            determineDataLimits: function () {
                                ...
                                for (t = 0, i = (f.data.datasets || []).length; t < i; ++t)
                                    if (f.isDatasetVisible(t))
                                        if (((l = f.data.datasets[t].data), o.isObject(l[0]))) for (y[t] = [], e = 0, a = l.length; e < a; ++e) (u = g(l[e], h)), x.push(u), (y[t][e] = u);
                            ...
                            buildTicks: function () {
                                ...
                                return (
                                    ...
                                    (y._offsets =
                                        ...
                                        (d = w).offset &&
                                            o.length &&
                                            (d.time.min || ((c = o.length > 1 ? o[1] : s), (v = o[0]), (b = (h(a, "time", c, "pos") - h(a, "time", v, "pos")) / 2)),
                                            d.time.max || ((c = o[o.length - 1]), (v = o.length > 1 ? o[o.length - 2] : r), (x = (h(a, "time", c, "pos") - h(a, "time", v, "pos")) / 2))),
                                        { left: b, right: x })),
